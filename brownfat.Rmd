...
Lets check for the distribution of the age:
    ```{r}
ggplot(data = brownfat_cleaned_data_v2, aes(x = Sex)) +
    geom_bar(fill = "grey")+
    ggtitle("Bar Plot of Sex")

ggplot(data = brownfat_cleaned_data_v2, aes(x = Diabetes)) +
    geom_bar(fill = "grey")+
    ggtitle("Bar Plot of Diabetes")

ggplot(data = brownfat_cleaned_data_v2, aes(x = Age))+
    geom_histogram()
ggplot(data = brownfat_cleaned_data_v2, aes(x = Day))+
    geom_histogram()
brownfat_cleaned_data_v2$Month <- factor(brownfat_cleaned_data_v2$Month, levels = 1:12)
ggplot(data = brownfat_cleaned_data_v2, aes(x = Month))+
    geom_bar()
...
ggplot(data = brownfat_cleaned_data_v2, aes(x = LBW))+
    geom_histogram()
ggplot(data = brownfat_cleaned_data_v2, aes(x = Cancer_Status)) +
    geom_bar(fill = "grey")+
    ggtitle("Bar Plot of Cancer Status")
ggplot(data = brownfat_cleaned_data_v2, aes(x = Cancer_Type)) +
    geom_bar(fill = "grey")+
