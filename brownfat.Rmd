...
extractAIC(fit_final_w_bf_inter)
```
As a result, all p-values for the remaining predictors are now all quite low. However also note the low no. of covariates, this could lead to bad generalization in larger datasets.
