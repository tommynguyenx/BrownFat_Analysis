...
While adjusted $R^2$ and AIC are at an all time high and low respectively, a lot of the covariates now have quite high p-values. Because of this, we'll now turn to the interaction model. (HOWEVER, keep in mind the $R^2$ and $R^2$ adjusted from the fitted model for $Y$ and for $\log(Y)$ is not comparable, use AIC instead). 
